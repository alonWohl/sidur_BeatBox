				...
				<Droppable
					...
					{(provided, snapshot) => (
						<div
							...
							className={`text-center h-10 border border-gray-200 ${
		...
		<DragDropContext onDragEnd={handleDragEnd}>
			<div className='flex flex-col items-center justify-center gap-4 p-1 container mx-auto'>
				...
				<div
					...
					<Table
						dir='rtl'
						className='min-w-[650px] bg-white border border-gray-200 rounded-lg '>
						<TableHeader>
							<TableRow>
								<TableHead className='text-center font-medium text-sm sticky right-0 z-10 bg-gray-50 p-1'>
									משמרת
								</TableHead>
										...
										<TableRow
											...
											{DAYS.map((day) => (
												<TableCell
													...
													className={`p-2 ${position === 1 ? '' : 'border-t-0'}`}>
