      ...
      <div className="max-w-md w-full mt-10">
        ...
        <div className="bg-white shadow-xl rounded-xl p-8 border border-gray-100">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-2">
              ...
              <Select onValueChange={handleUserChange} value={user.username} name="username" dir="rtl">
                ...
                <SelectContent className="text-right">
                  <SelectItem value="moked" className="text-right flex items-center gap-2">
                    <span className="flex-1">מוקד</span>
                    <Building2 className="h-3.5 w-3.5 text-gray-400 flex-shrink-0" />
                  </SelectItem>
                  <SelectItem value="tlv" className="text-right flex items-center gap-2">
                    <span className="flex-1">תל אביב</span>
                    <Building2 className="h-3.5 w-3.5 text-gray-400 flex-shrink-0" />
                  </SelectItem>
                  <SelectItem value="pt" className="text-right flex items-center gap-2">
                    <span className="flex-1">פתח תקווה</span>
                    <Building2 className="h-3.5 w-3.5 text-gray-400 flex-shrink-0" />
                  </SelectItem>
                  <SelectItem value="rishon" className="text-right flex items-center gap-2">
                    <span className="flex-1">ראשון לציון</span>
                    <Building2 className="h-3.5 w-3.5 text-gray-400 flex-shrink-0" />
                  </SelectItem>
                  <SelectItem value="rosh" className="text-right flex items-center gap-2">
            ...
            <Button type="submit" className="w-full bg-[#BE202E] hover:bg-[#BE202E]/90 text-white shadow-sm transition-all" disabled={isSubmitting}>
              {isSubmitting ? (
